                ...
                {isAsn && (
                  <>
                    <Link
                      ...
                      className="flex items-center gap-2 rounded-md px-3 py-3 text-sm font-medium text-surface-foreground hover:bg-muted"
                    >
                      <FileText className="h-4 w-4" /> Tugas Saya (Form)
                    </Link>
                    <Link
                      to="/asn/absensi"
                      onClick={() => setOpen(false)}
                    ...
                    <Link
                      ...
                      className="flex items-center gap-2 rounded-md px-3 py-3 text-sm font-medium text-surface-foreground hover:bg-muted"
                    >
                      <FileText className="h-4 w-4" /> Izin & Cuti
                    </Link>
                    <Link
                      to="/asn/lembur"
                      onClick={() => setOpen(false)}
                      className="flex items-center gap-2 rounded-md px-3 py-3 text-sm font-medium text-surface-foreground hover:bg-muted"
                    >
                      <FileText className="h-4 w-4" /> Lembur
                    </Link>
                    <Link
                      to="/asn/aset"
                      onClick={() => setOpen(false)}
                    ...
                    <Link
                      ...
                      className="flex items-center gap-2 rounded-md px-3 py-3 text-sm font-medium text-surface-foreground hover:bg-muted"
                    >
                      <FileText className="h-4 w-4" /> Dokumen Saya
                    </Link>
                  </>
                )}
                {isAdmin && (
